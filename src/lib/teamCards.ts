...
export const generalDerivationNotes = [
  ...
  "Cross-era matchup cards expose a league-strength diagnostic from full-season roster depth, qualified player depth per team, and league team count, but the default simulator does not apply it as a mechanical shot, turnover, or rebound boost.",
