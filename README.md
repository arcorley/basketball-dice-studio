...
- Matchup scoresheets can be exported directly to a shot-focused landscape
  PDF with large per-player quarter tracking areas, quarter subtotals, and
  inline possession boxes by quarter.
